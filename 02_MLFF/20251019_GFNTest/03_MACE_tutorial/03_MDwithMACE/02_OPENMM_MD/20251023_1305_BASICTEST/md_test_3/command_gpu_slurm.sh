...
mace-md -f ionpairs.xyz --model_path /data/dydtkddhkdwk/20251023_MACE_MD_OPENMM/20251023_1305_BASICTEST/MYMODEL/mace_off_finetune_stagetwo_compiled.model --output_dir ./ --steps 1000 --unwrap --minimiser openmm \
