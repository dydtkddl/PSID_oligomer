...
#SBATCH -t 1-0
#SBATCH -o /data/dydtkddhkdwk/20251023_MACE_MD_OPENMM/20251023_1305_BASICTEST/20251023_2317_md_test_6_args/EXP07_5000step_with_minimise/slurm-%A.out
#SBATCH -e /data/dydtkddhkdwk/20251023_MACE_MD_OPENMM/20251023_1305_BASICTEST/20251023_2317_md_test_6_args/EXP07_5000step_with_minimise/slurm-%A.err
...
# ✅ 여기 두 줄 추가 (autograd OFF)
export PYTORCH_NO_GRAD=1
export PYTORCH_ENABLE_GRAD=0
export MACE_DISABLE_AUTOGRAD=1
...
python run_mace_md.py \
 "mace-md \
  ...
  --nl torch \
  --minimiser openmm \
  --optimized_model "  2>&1 | tee "$WORKDIR/logs/NVT_$SLURM_JOB_ID.log"  
